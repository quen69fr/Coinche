...
Y_IMAGE_SAUVEGARE_BOUTON = HAUTEUR - 8 - HAUTEUR_IMAGE_BOUTON
...
IMAGE_TAKE_BACK_BOUTON = pygame.image.load('Image/RevenirBouton.png')
X_IMAGE_TAKE_BACK_BOUTON = LARGEUR - 8 - LARGEUR_IMAGE_BOUTON
Y_IMAGE_TAKE_BACK_BOUTON = HAUTEUR - 8 - HAUTEUR_IMAGE_BOUTON
IMAGE_RELOAD_BOUTON = pygame.image.load('Image/ReconnecteBouton.png')
X_IMAGE_RELOAD_BOUTON = 8
Y_IMAGE_RELOAD_BOUTON = 8
